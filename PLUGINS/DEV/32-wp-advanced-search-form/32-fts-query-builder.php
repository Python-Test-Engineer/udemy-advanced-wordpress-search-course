                ...
                <div class="fts-admin-info-box" style="background: #fff3e0; border-left-color: #ff9800;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <table style="width: 100%; font-size: 13px; margin-top: 10px;">
                            ...
                            <tr><td style="padding: 5px; background: #f5f5f5;"><strong>Boost Terms:</strong></td><td style="padding: 5px; background: #f5f5f5;">cooling</td></tr>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <table style="width: 100%; font-size: 13px; margin-top: 10px;">
                            ...
                            <tr><td style="padding: 5px; background: #f5f5f5;"><strong>Reduce Terms:</strong></td><td style="padding: 5px; background: #f5f5f5;">refurbished</td></tr>
                        ...
                        <p style="margin-top: 10px; font-size: 12px; color: #666;">
                            <strong>Result Query:</strong> <code>laptop +SSD +16GB -refurbished -used &lt;refurbished (Dell|HP|Lenovo)</code>
                        </p>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <table style="width: 100%; font-size: 13px; margin-top: 10px;">
                            ...
                            <tr><td style="padding: 5px; background: #f5f5f5;"><strong>Boost Terms:</strong></td><td style="padding: 5px; background: #fff;">senior</td></tr>
                        ...
                        <p style="margin-top: 10px; font-size: 12px; color: #666;">
                            <strong>Result Query:</strong> <code>+developer +remote -junior -intern -unpaid develop* &gt;senior (Python|JavaScript|React)</code>
                        </p>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <table style="width: 100%; font-size: 13px; margin-top: 10px;">
                            ...
                            <tr><td style="padding: 5px; background: #fff;"><strong>Reduce Terms:</strong></td><td style="padding: 5px; background: #fff;">fried</td></tr>
                        ...
                        <p style="margin-top: 10px; font-size: 12px; color: #666;">
                            <strong>Result Query:</strong> <code>dinner recipe +healthy +quick -fried -dessert "30 minutes" &lt;fried (chicken|fish|vegetarian)</code>
                        </p>
                    </div>
                </div>
